...
# ANTHROPIC_BASE = os.getenv("ANTHROPIC_BASE", "https://api.anthropic.com")  # disabled

class LLMClient:
    def __init__(self):
        self.openai_key = os.getenv("OPENAI_API_KEY")
        self.openai_model = os.getenv("OPENAI_MODEL", "gpt-4o-mini")
        # self.anthropic_key = os.getenv("ANTHROPIC_API_KEY")  # disabled
        # self.anthropic_model = os.getenv("ANTHROPIC_MODEL", "claude-3-5-sonnet-latest")  # disabled
    ...
    async def complete(self, system: str, user: str) -> str:
        ...
        if provider == "openai":
            ...
            # Anthropic disabled
            raise RuntimeError("Anthropic provider is disabled in this deployment.")
